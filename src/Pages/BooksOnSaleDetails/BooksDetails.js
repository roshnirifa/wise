...
import BooksOnSaleDetails from '../../Hooks/BooksOnSaleDetailsHook';
import './BooksDetails.css'
import FirstSlotBooks from './FirstSlotBooks';

import ReviewForm from './ReviewForm';

const BooksDetails = () => {
    const { id } = useParams();
    const [service] = BooksOnSaleDetails(id);
                        ...
                        <div>
                            ...
                            <div>
                                <div className='w-10/12 align-middle container mx-auto mt-10'>
                                    ...
                                    {active === "FirstCard" && <FirstSlotBooks bookOnSale={bookOnSale} title="1" />}
                                    {active === "SecoundCard" && <ReviewForm bookOnSale={bookOnSale} title="2"></ReviewForm>}
                                </div>
