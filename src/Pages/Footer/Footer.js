...
const Footer = () => {
    return (
        <div>
            ...
            <footer class="footer p-10 bg-base-200 flex justify-around items-center  text-base-content ">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p>Wise E-Commerce Shop Ltd. <br />Providing reliable tech since 1992</p>
                </div>
